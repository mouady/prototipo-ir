        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-7xl w-full">
          ...
          >
            ...
            <div className="relative">
              ...
              <p className="text-slate-300 mb-6 leading-relaxed">
                Interfaz móvil para gestionar la cocina. Visualiza avisos 
                y gestiona tus fichajes de entrada y salida.
              </p>
          ...
          >
            ...
            <div className="relative">
              <div className="w-16 h-16 bg-gradient-to-br from-amber-400 to-amber-500 rounded-2xl flex items-center justify-center mb-6 shadow-lg group-hover:shadow-xl transition-shadow">
                <ChefHat className="w-8 h-8 text-white" />
              </div>
              ...
              <p className="text-slate-300 mb-6 leading-relaxed">
                Panel de escritorio con gestión de comandas. Visualiza órdenes 
                pendientes y marca platos como completados.
              </p>
            ...
            {/* Badge escritorio */}
            <div className="absolute bottom-4 right-4 px-3 py-1 bg-amber-500/20 text-amber-300 text-xs font-medium rounded-full border border-amber-500/30">
              🖥️ Escritorio
            </div>
          </Link>
