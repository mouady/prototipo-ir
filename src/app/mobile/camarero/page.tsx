...
const VIEW_COMPONENTS: Record<CamareroView, React.ComponentType> = {
  [CamareroView.FICHAJES]: FichajesView,
  [CamareroView.COMANDAS]: ComandasView,
  [CamareroView.MESAS]: MesasView,
  [CamareroView.RESERVAS]: ReservasView,
};

// Mapa de vistas a títulos
const VIEW_TITLES: Record<CamareroView, string> = {
  [CamareroView.FICHAJES]: "Fichajes",
